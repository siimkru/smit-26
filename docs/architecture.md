...
Gradle'is on lisaks seadistatud Checkstyle, PMD, SpotBugs/FindSecBugs ja JaCoCo; `./gradlew check` käivitab need kontrollid ning nõuab vähemalt 70% ridade katvust. GitHub Actions käivitab `check` ja eraldiseisva `integrationTest` task'i.
