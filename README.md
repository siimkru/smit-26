...
Kontrollitud commit'i `b36dcbf` workflow-jooksud ja nende raportid:

- [Unit tests](https://github.com/siimkru/smit-26/actions/runs/34753981500) — unit-testid ja staatilised kontrollid; artefakt `unit-test-html-report`.
- [Integration tests](https://github.com/siimkru/smit-26/actions/runs/34754450419) — päris OpenAI integratsioonitestid; artefakt `integration-test-html-report`.
